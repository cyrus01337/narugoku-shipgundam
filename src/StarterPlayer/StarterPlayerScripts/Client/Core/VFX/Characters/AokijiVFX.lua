...
local AokijiVFX = {
    ...
    ["Ice Freeze"] = function(PathData)
        ...
        for Index = 1, 18 do
            VfxHandler.FloorFreeze(
                Root.CFrame * CFrame.new(0, 1, -Index * 3.8),
                100,
                10,
                15,
                nil,
                3,
                Vector3.new(15, 0.989, 15),
                Character
            )
            wait()
        end
    ...
    ["Ice Sword"] = function(PathData)
        ...
        elseif PathData.Index == 2 then
            ...
            local TweenOne = TweenService:Create(
                ...
                TweenInfo.new(0.15, Enum.EasingStyle.Linear, Enum.EasingDirection.Out),
                {
                    ["CFrame"] = one.CFrame * CFrame.Angles(math.rad(3.36), math.rad(-76.51), math.rad(-12.76)),
                    ["Size"] = StartSizeOne * Multiple,
                }
            )
            TweenOne:Play()
            ...
            local TweenTwo = TweenService:Create(
                ...
                TweenInfo.new(0.15, Enum.EasingStyle.Linear, Enum.EasingDirection.Out),
                {
                    ["CFrame"] = two.CFrame * CFrame.Angles(math.rad(3.36), math.rad(-76.51), math.rad(-12.76)),
                    ["Size"] = StartSizeTwo * Multiple,
                }
            )
            TweenTwo:Play()
        ...
        for Index = 1, 25 * _G.FPS / 60 do
            if RandomIndex <= Number then
                break
            end
            SlashEffect.CFrame = SlashEffect.CFrame:lerp(
                CFrameIndex
                    * CFrame.Angles(0, math.rad(Index * ToMultiply * ToMultiply) * 60 / _G.FPS, 0)
                    * CFrame.new(0, 0, 10),
                1
            )
    ...
    ["Ice Stomp"] = function(PathData)
        ...
        coroutine.wrap(function()
            for Index = 1, 3 do
                ...
                local Tween = TweenService:Create(
                    ...
                    { ["Transparency"] = 1, ["Size"] = Vector3.new(60, 60, 60) }
                )
                Tween:Play()
                Tween:Destroy()
                ...
                local c1, c2 =
                    RootPart.CFrame * CFrame.new(0, 0, -1) * CFrame.Angles(math.pi / 2, 0, 0),
                    RootPart.CFrame * CFrame.new(0, 0, -50) * CFrame.Angles(math.pi / 2, 0, 0)
                cs.CFrame = c1
                ...
                local Tween = TweenService:Create(
                    ...
                    {
                        ["Transparency"] = 1,
                        ["Size"] = Vector3.new(25 + (Index * 10), 0, 25 + (Index * 10)),
                        ["CFrame"] = c2,
                    }
                )
                Tween:Play()
        ...
        local Tween = TweenService:Create(
            ...
            { ["CFrame"] = GoalCFrame * CFrame.new(0, 0, 2) }
        )
        Tween:Play()
        Tween:Destroy()
