...
local HieiVFX = {
	...
	--	if Character:FindFirstChild("HieiHit") == nil then return end
		...
		for loops = 1,2 do
			coroutine.wrap(function()
				...
				for j = 1,15 do
					i += 1 
					--[[ Raycast ]]--
					local StartPosition = (Character.HumanoidRootPart.CFrame  * CFrame.new(2,0,0) * CFrame.new(OffsetX,0,-i/100)).Position
					local EndPosition = CFrame.new(StartPosition).UpVector * -10
		...
		coroutine.wrap(function()
			for i = 1,2 do
				...
				for i = 1,5 do
					...
					beam.CFrame = CFrame.new(originalPos + Vector3.new(math.random(-1,1),math.random(-1,1),math.random(-1,1)), originalPos) 
					local tween = TweenService:Create(beam, TweenInfo.new(.1, Enum.EasingStyle.Quart, Enum.EasingDirection.Out), {["Size"] = beam.Size + Vector3.new(0,0, math.random(.5,1)), ["CFrame"] = beam.CFrame * CFrame.new(0,0,math.random(9,13))})
					local tween2 = TweenService:Create(beam, TweenInfo.new(.1, Enum.EasingStyle.Quart, Enum.EasingDirection.In), {["Size"] = Vector3.new(0,0,2)})		
					tween:Play()
					tween:Destroy()
					tween2:Play()
					tween2:Destroy()
				...
				for j = 1,2 do
					...
					beam.CFrame = CFrame.new(originalPos + Vector3.new(math.random(-1,1),math.random(-1,1),math.random(-1,1)), originalPos) 
					local tween = TweenService:Create(beam, TweenInfo.new(.1, Enum.EasingStyle.Quart, Enum.EasingDirection.Out), {["Size"] = beam.Size + Vector3.new(0,0, math.random(.5,1))})
					local tween2 = TweenService:Create(beam, TweenInfo.new(.1, Enum.EasingStyle.Quart, Enum.EasingDirection.In), {["Size"] = Vector3.new(0,0,30*i)})		
					tween:Play()
					tween:Destroy()
					tween2:Play()
					tween2:Destroy()
		...
		one.CFrame = Character.HumanoidRootPart.CFrame * CFrame.new(0,1,0) * CFrame.fromEulerAnglesXYZ(math.rad(90),math.rad(45),0)
		two.CFrame = Character.HumanoidRootPart.CFrame * CFrame.new(0,1,0) * CFrame.fromEulerAnglesXYZ(math.rad(90),math.rad(45),0)
		...
		for i = 1, 10 do
			...
			one.CFrame = Character.HumanoidRootPart.CFrame * CFrame.new(0,1,0) * CFrame.fromEulerAnglesXYZ(math.rad(math.random(0,360)),math.rad(math.random(0,360)),0)
			two.CFrame = Character.HumanoidRootPart.CFrame * CFrame.new(0,1,0) * CFrame.fromEulerAnglesXYZ(math.rad(math.random(0,360)),math.rad(math.random(0,360)),0)
		...
		for i = 1,5 do
			...
			PointA = PointA + Vector3.new(math.random(-Offset,Offset),math.random(Offset/2, Offset),math.random(-Offset,Offset))
			PointB = PointB + Vector3.new(math.random(-Offset,Offset),math.random(Offset/2, Offset),math.random(-Offset,Offset))	
			...
			coroutine.wrap(function()
				...
				for i = 1, Magnitude, Speed do
					...
					local tween = TweenService:Create(trail,TweenInfo.new(.25,Enum.EasingStyle.Quad,Enum.EasingDirection.Out),{Size = Vector3.new(0,trail.Size.Y+3,0), Color = Color3.fromRGB(111, 111, 168)})
					tween:Play()
					tween:Destroy()
					game.Debris:AddItem(trail,.25)
					trail.Parent = Visuals
	...
	["SwordOfDarkness"] = function(PathData)
		...
		cylinder.CFrame = Character.HumanoidRootPart.CFrame * CFrame.new(0,0,-25) * CFrame.fromEulerAnglesXYZ(math.rad(90),0,0)
		cylinder.Parent = Visuals
		
		local Tween = TweenService:Create(cylinder, TweenInfo.new(0.25, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {["Size"] = Vector3.new(0,cylinder.Size.Y,0)})
		Tween:Play()
		Tween:Destroy()
	...
	["BlackDragonHellfire"] = function(PathData)
		...
		local function DragonImpact(Dragon)
			...
			Fire.Cremation.Lifetime = NumberRange.new(0.5)
			Fire.Cremation.Size = NumberSequence.new{NumberSequenceKeypoint.new(0, 20), NumberSequenceKeypoint.new(1, 0)}
			Fire.Cremation.Acceleration = Vector3.new(0,-5,0)
			Fire.Cremation.Rate = 200
			...
			for i, v in pairs(Dragon.Parent:GetChildren()) do
				local Tween = TweenService:Create(v, TweenInfo.new(0.25, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {["Transparency"] = 1})
				Tween:Play()
				Tween:Destroy()
			end
			...
			coroutine.wrap(function()
				wait(.2)
				local tween = TweenService:Create(shock,TweenInfo.new(.2,Enum.EasingStyle.Quad,Enum.EasingDirection.In),{Size = Vector3.new(0,80,0), Color = Color3.fromRGB(111, 111, 168)})
				tween:Play()
				tween:Destroy()
			...
			Shockwave.Shockwave.Size = NumberSequence.new{NumberSequenceKeypoint.new(0, 0), NumberSequenceKeypoint.new(1, 120)}
			...
			coroutine.wrap(function()
				for j = 1,3 do
					for i = 1,6 do
						...
						beam.CFrame = CFrame.new(originalPos + Vector3.new(math.random(-1,1),math.random(-1,1),math.random(-1,1)), originalPos) 
						local tween = TweenService:Create(beam, TweenInfo.new(.15, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {["Size"] = beam.Size + Vector3.new(0,0, math.random(2,5)), ["CFrame"] = beam.CFrame * CFrame.new(0,0,50)})
			...
			--// Lightning 
			Offset = 60
			local StartPosition = (Vector3.new(math.sin(360)*Offset, 0, math.cos(360)*Offset) + (Dragon.Position + Vector3.new(0,5,0)))
			local EndPosition = CFrame.new(StartPosition).UpVector * -10
			...
			if ray then
				...
				if pos then
					...
					for i = 1,20 do
						...
						local newEndPosition = (Vector3.new(math.sin(360*i)*Offset, 0, math.cos(360*i)*Offset) + Dragon.Position)
		...
		for i = 1, Magnitude, Speed do
			...
			local Percent = i/Magnitude
			local Coordinate = BezierModule:cubicBezier(Percent, StartPosition, PointA, PointB, EndPosition)
			Dragon.Head.CFrame = Dragon.Head.CFrame:Lerp(CFrame.new(Coordinate, EndPosition)* CFrame.fromEulerAnglesXYZ(math.rad(270),0,math.rad(90)), Percent) 
			...
			trail.CFrame = CFrame.lookAt(Coordinate,nextPoint)*CFrame.Angles(math.rad(90),0,0)
			local tween = TweenService:Create(trail,TweenInfo.new(.5,Enum.EasingStyle.Quad,Enum.EasingDirection.Out),{Size = Vector3.new(0,trail.Size.Y+8,0), Color = Color3.fromRGB(111, 111, 168)})
			tween:Play()
			tween:Destroy()
			game.Debris:AddItem(trail,.5)
			trail.Parent = Visuals
	...
	["Charge"] = function(Data)
		...
		coroutine.wrap(function()
			...
			for j = 1,60 do
				for i = 1,1 do
					...
					Sphere.CFrame = Character.HumanoidRootPart.CFrame * CFrame.new(math.random(-4,4)*i,-5,math.random(-2,2)*i)
					Sphere.Parent = Visuals

					local tween = TweenService:Create(Sphere, TweenInfo.new(.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {["Transparency"] = 1, ["Position"] = Sphere.Position + Vector3.new(0,math.random(7.5,10),0)})
					tween:Play()
					tween:Destroy()
		...
		Smoke.Smoke.Drag = 5
		Smoke.Smoke.Lifetime = NumberRange.new(.35)
	...
	["HieiScreen"] = function(Data)
		...
		local tween2 = TweenService:Create(ColorCorrection, TweenInfo.new(0.075, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {["TintColor"] = Color3.fromRGB(0, 0, 0), ["Brightness"] = 0, ["Contrast"] = 0, ["Saturation"] = -1})
		tween2:Play()
		tween2:Destroy()

		wait(0.075)
		local tween2 = TweenService:Create(ColorCorrection, TweenInfo.new(0.075, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {["TintColor"] = Color3.fromRGB(85, 0, 0), ["Brightness"] = 0, ["Contrast"] = 0, ["Saturation"] = 0})
		tween2:Play()
		tween2:Destroy()

		wait(0.1)
		local tween2 = TweenService:Create(ColorCorrection, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {["TintColor"] = Color3.fromRGB(255, 255, 255), ["Brightness"] = 0, ["Contrast"] = 0, ["Saturation"] = 0})
		tween2:Play()
		tween2:Destroy()
