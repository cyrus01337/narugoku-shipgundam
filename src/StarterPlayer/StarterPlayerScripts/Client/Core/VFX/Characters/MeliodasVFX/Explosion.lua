...
return function(Data)
	...
	local tween = TweenService:Create(Ball, TweenInfo.new(0.25, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {["Transparency"] = 1, ["Size"] = Ball.Size * 7})
	tween:Play()
	tween:Destroy()
	...
	Rocks.Rocks.Size = NumberSequence.new{NumberSequenceKeypoint.new(0, math.random(5,10)/10), NumberSequenceKeypoint.new(1, 0)}
	Rocks.Rocks.Drag = 5
