...
local tii = TweenInfo.new(0.15, Enum.EasingStyle.Linear, Enum.EasingDirection.Out, 0, false, 0)
...
local RazorVFX = {
    ...
    ["Chop"] = function(Data)
        ...
        VfxHandler.AfterImage({ Character = Character, Duration = 1, StartTransparency = 0.25 })
    ...
    ["BallPrep"] = function(Data)
        ...
        if PremadeVolleyball then
            PremadeVolleyball:Destroy()
        end

        local Volleyball

        Volleyball = Data.Type == nil and ReplicatedStorage.Assets.Models.Misc.Volleyballs.volleymodel
            or Data.Type == "Explode" and ReplicatedStorage.Assets.Models.Misc.Volleyballs.explodball
        ...
        local Tween = TweenService:Create(
            Volleyball.PrimaryPart,
            TweenInfo.new(0.5, Enum.EasingStyle.Elastic, Enum.EasingDirection.InOut, 0, false, 0),
            { Size = Vector3.new(1.545, 1.545, 1.545) }
        )
        Tween:Play()
        Tween:Destroy()
    ...
    ["explodball"] = function(Data)
        ...
        local Velocity = VelocityCalculation(Position, Root.Position, Vector3.new(0, -workspace.Gravity, 0), 0.9)
        ...
        coroutine.resume(coroutine.create(function()
            ...
            VfxHandler.FakeBodyPart({
                ...
                TweenColor = Color3.fromRGB(136, 26, 26),
                Transparency = 1,
                Duration = 1,
                Delay = 0.1,
                Type = "Trail",
        ...
        local Points = RaycastService:GetSquarePoints(
            CFrame.new(Volleyball.PrimaryPart.Position),
            Volleyball.PrimaryPart.Size.X,
            Volleyball.PrimaryPart.Size.X
        )
        ...
        RaycastService:CastProjectileHitbox({
            ...
            Function = function(RaycastResult)
                Explosions.ExplodingThrow({
                    Character = Character,
                    RaycastResult = RaycastResult,
                    Volleyball = Volleyball.PrimaryPart,
