...
local KilluaVFX = {
    ...
    ["WhirldWindSlam"] = function(Data)
        ...
        if Target then
            for Index = 1, math.random(6, 10) do
                ...
                local ColorIndex = Index >= 3 and Data.Color
                    or Color3.fromRGB(117, 237, 255)
    ...
    ["WhirlWindHit"] = function(Data)
        ...
        if GlobalFunctions.CheckDistance(Player, 35) then
            GlobalFunctions.FreshShake(85, 25, 1, 0.2, 0)
        end
    ...
    ["Skateboard"] = function(PathData)
        ...
        while wait() do
            ...
            if Root:FindFirstChild("SkateBoard") == nil then
                break
            end
        end
    ...
    ["ThunderPalmRelease"] = function(BackData)
        ...
        Debris:AddItem(PointLight2, 0.2)
    ...
    ["LightningPalmStart"] = function(Data)
        ...
        for _ = 1, 2 do
            ...
            RightArm.Size = Character["Right Arm"].Size + Vector3.new(0.035, 0.035, 0.035)
            ...
            LeftArm.Size = Character["Left Arm"].Size + Vector3.new(0.035, 0.035, 0.035)
    ...
    ["Snake Awakens"] = function(PathData)
        ...
        coroutine.resume(coroutine.create(function()
            for _ = 1, 20 do
                ...
                Clone.CFrame = Part.CFrame
                    * CFrame.Angles(math.random(-0.65, 14.59), math.random(-128.24, -117.79), math.random(-14.3, 8.39))
                Clone.Parent = workspace.World.Visuals
                ...
                GlobalFunctions.TweenFunction(
                    ...
                    },
                    {
                        ["CFrame"] = Part.CFrame * CFrame.Angles(
                            math.random(-0.65, 14.59),
                            math.random(-128.24, -117.79),
                            math.random(-14.3, 8.39)
                        ),
                        ["Transparency"] = 1,
                    }
                )
        ...
        for _ = 1, 25 do
            ...
            Debris:AddItem(Clone, 0.5) -- up 2, down 3
