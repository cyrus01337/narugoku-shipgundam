...
local LuffyVFX = {
    ...
    ["GatlingHitVFX"] = function(Data)
        ...
        VfxHandler.Orbies({
            Parent = VRoot,
            Size = Vector3.new(0.565, 0.565, 0.565),
            Color = Color3.fromRGB(255, 255, 255),
            Speed = 0.2,
    ...
    ["Gatling"] = function(PathData)
        ...
        for _ = 1, 115 do
            ...
            local Tween = TweenService:Create(Arm, TweenInfo.new(0.2, Enum.EasingStyle.Quad), { Transparency = 1 })
            Tween:Play()
            Tween:Destroy()
            ...
            for _, v in ipairs(Arm:GetDescendants()) do
                if v:IsA("Decal") or v:IsA("UnionOperation") then
                    local Animate =
                        TweenService:Create(v, TweenInfo.new(0.35, Enum.EasingStyle.Quad), { Transparency = 1 })
                    Animate:Play()
                    Animate:Destroy()
                end
            end
    ...
    ["Pistole"] = function(PathData)
        ...
        WindMesh.CFrame = Character.HumanoidRootPart.CFrame
            * CFrame.new(0, 0, -15)
    ...
    ["Axe"] = function(PathData)
        ...
        local function GroundTouched(RootPos, PartHit)
            ...
            local Smoke = Particles.Smoke:Clone()
            Smoke.Smoke.Size =
                NumberSequence.new({ NumberSequenceKeypoint.new(0, 0), NumberSequenceKeypoint.new(1, 5) })
            Smoke.Smoke.Drag = 5
            Smoke.Smoke.Lifetime = NumberRange.new(0.75, 1)
        ...
        coroutine.wrap(function()
            ...
            for j = 1, 10 do
                for i = 1, 5 do
                    ...
                    Block.CFrame = Character.HumanoidRootPart.CFrame
                        * CFrame.new(math.random(-5, 5) * i, 50, math.random(-2, 2) * i)
                    Block.Parent = Visuals
        ...
        local tween = TweenService:Create(
            ...
            TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
            {
                ["CFrame"] = shockwave5.CFrame * CFrame.new(0, 25, 0) * CFrame.fromEulerAnglesXYZ(0, 5, 0),
    ...
    ["Bazooka"] = function(PathData)
        ...
        Block.CFrame = Character.HumanoidRootPart.CFrame
            * CFrame.new(0, 0, -15)
            * CFrame.fromEulerAnglesXYZ(0, math.rad(90), math.rad(180))
        Block.Parent = Visuals
