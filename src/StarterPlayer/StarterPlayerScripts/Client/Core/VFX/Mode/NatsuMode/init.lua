...
local NatsuLightning = require(script.NatsuLightning)
...
local NatsuMode = {
    ...
    ["NatsuScreen"] = function(Data)
        ...
        local tween2 = TweenService:Create(
            ...
            { ["TintColor"] = Color3.fromRGB(204, 204, 204), ["Contrast"] = 0, ["Saturation"] = -1 }
        )
        tween2:Play()
        tween2:Destroy()
        ...
        local tween2 = TweenService:Create(
            ...
            { ["TintColor"] = Color3.fromRGB(0, 0, 0), ["Contrast"] = 0, ["Saturation"] = -1 }
        )
        tween2:Play()
        tween2:Destroy()
        ...
        local tween2 = TweenService:Create(
            ...
            { ["TintColor"] = Color3.fromRGB(255, 0, 0), ["Brightness"] = 0, ["Contrast"] = 0, ["Saturation"] = 0 }
        )
        tween2:Play()
        tween2:Destroy()
    ...
    ["FiredUp"] = function(Data)
        ...
        for i = 1, 2 do
            ...
            local tween = TweenService:Create(
                shock,
                TweenInfo.new(0.15, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
                { Size = Vector3.new(12, 12, 12), CFrame = shock.CFrame
                    * CFrame.new(0, 2, 0)
            ...
            delay(0.15, function()
                local tween = TweenService:Create(
                    ...
                    { Size = Vector3.new(0, 10, 0), Color = Color3.fromRGB(255, 85, 0) }
                )
                tween:Play()
                tween:Destroy()
            ...
            Rocks.Rocks.Size = NumberSequence.new({
                NumberSequenceKeypoint.new(0, math.random(5, 10) / 20),
            ...
            for _ = 1, 5 do
                createhugelightning(
                    RootCFrame.Position,
                    RootCFrame.Position + Vector3.new(math.random(-15, 15), math.random(5, 15), math.random(-15, 15)),
                    3
                )
            end
            wait(0.75)
    ...
    ["LightningBurst"] = function(Data)
        ...
        local Ti3 = TweenInfo.new(0.02, Enum.EasingStyle.Linear, Enum.EasingDirection.Out, 4, true, 0)
        ...
        local Tween = TweenService:Create(
            ...
            { CFrame = End * CFrame.new(0, 1.5, 10), Size = Vector3.new(0, 0, NewLine.Size.Z) }
        )
        Tween:Play()
        Tween:Destroy()

        NewLine.Parent = workspace.World.Visuals
        Debris:AddItem(NewLine, 0.4)
        ...
        if RaycastResult and RaycastResult.Instance and (RaycastResult.Position - p1).Magnitude < 30 then
            ...
            FirstDust.CFrame = End * CFrame.Angles(0, 0.3, 0) * CFrame.new(3, 0, 0)
            ...
            SecondDust.CFrame = End * CFrame.Angles(0, -0.3, 0) * CFrame.new(-3, 0, 0)
        ...
        if Result and Result.Instance then
            ...
            DirtStep.CFrame = Root.CFrame * CFrame.new(0, -1.85, 0.225)
        ...
        local Max = 200
        TaskScheduler:AddTask(0.2, function()
            for Index = 1, 10 do
                local Max = Max - 10
        ...
        TaskScheduler:AddTask(0.1, function()
            NatsuLightning({ Character = Character, Distance = Data.Distance })
        end)
    ...
    ["LightningDragonHammer"] = function(Data)
        ...
        for i, v in pairs(Character:GetDescendants()) do
            if v.Name == "NatsuFireEffect" then
    ...
    ["LightningDragonCrimsonStart"] = function(Data)
        ...
        for i, v in ipairs(Character:GetChildren()) do
            if v:IsA("MeshPart") or v:IsA("BasePart") then
                ...
                Attachment.Fire.Size =
                    NumberSequence.new({ NumberSequenceKeypoint.new(0, 3), NumberSequenceKeypoint.new(1, 5) })
                ...
                Attachment.Name = "NatsuFireEffect"
            end
        end
            ...
            for j = 1, 2 do
                ...
                for i = 1, 5 do
                    ...
                    local newEndPosition = (
                        Vector3.new(math.sin(360 * i) * Offset, 0, math.cos(360 * i) * Offset) + Root.Position
                    )
                    ...
                    for i = 1, 2 do
                        local ranCF =
                            CFrame.fromAxisAngle((newEndPosition - newStartPosition).Unit, 2 * math.random() * math.pi)
        ...
        if Data.SSJRock then
            for j = 1, 25 do
                for i = 1, math.random(1, 2) do
                    ...
                    --
                    local StartPosition = (
                        Vector3.new(math.sin(360 * j) * math.random(10, 14), 0, math.cos(360 * j) * math.random(10, 14))
    ...
    ["LightningDragonCrimsonMove"] = function(Data)
        ...
        coroutine.wrap(function()
            for i = 1, 2 do
                ...
                Attachment.Fire.Size =
                    NumberSequence.new({ NumberSequenceKeypoint.new(0, 4), NumberSequenceKeypoint.new(1, 0) })
    ...
    ["LightningDragonCrimsonEnd"] = function(Data)
        ...
        coroutine.wrap(function()
            ...
            for i = 1, 2 do
                ...
                DistanceThunder({
                    Character = Character,
                    Position = (RootCFrame * CFrame.fromEulerAnglesXYZ(-math.rad(22), 0, 0) * CFrame.new(0, 0, -100)).Position,
                })
                wait(0.1)
            end
        ...
        coroutine.wrap(function()
            for i = 0, 7 do
                local RingInnit = EffectMeshes.RingInnit:Clone()
                RingInnit.CFrame = RootCFrame
                    * CFrame.fromEulerAnglesXYZ(-math.rad(22), 0, 0)
                    * CFrame.new(0, -10, -(i * 10))
                    * CFrame.fromEulerAnglesXYZ(math.rad(90), 0, 0)
