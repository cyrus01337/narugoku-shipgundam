...
return function(Data)
	...
	LightningExplosion.new(Root.Position, .35, 12, ColorSequence.new(Color3.fromRGB(255, 251, 134)), ColorSequence.new(Color3.fromRGB(255, 85, 0), Color3.fromRGB(255, 255, 255)), nil)
