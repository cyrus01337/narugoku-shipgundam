...
local B6 = TweenInfo.new(0.2, Enum.EasingStyle.Linear, Enum.EasingDirection.Out, 0, false, 0)
        ...
        for Index = 1, 12 do
            ...
            if RandomIndex == 1 then
                ...
                if results and results.Instance and (results.Position - r1).Magnitude < 100 then
                    local c1 = results.Position + Vector3.new(0, -(Size2 + 0.2), 0)
                    ...
                    local Tween =
                        TweenService:Create(Part, B6, { CFrame = CFrame.new(c2) * CFrame.Angles(a2x, a2y, a2z) })
                    Tween:Play()
                    Tween:Destroy()
                    ...
                    coroutine.resume(coroutine.create(function()
                        wait(0.8)
                        local Tween =
                            TweenService:Create(Part, B6, { CFrame = CFrame.new(c1) * CFrame.Angles(ax, ay, az) })
                        Tween:Play()
                        Tween:Destroy()
                    end))
                end
...
local ZenitsuMode = {
    ["Transformation"] = function(Data)
            ...
            for j = 1, 185 do
                for i = 1, 1 do
                    ...
                    local Tween = TweenService:Create(
                        ...
                        {
                            ["Size"] = Vector3.new(0, Sphere.Size.Y, Sphere.Size.Z),
                            ["Transparency"] = 1,
                            ["Position"] = Sphere.Position + Vector3.new(0, math.random(7.5, 10), 0),
                        }
                    )
                    Tween:Play()
                    Tween:Destroy()
        ...
        for j = 1, 25 do
            for i = 1, math.random(1, 2) do
                ...
                RayData.FilterDescendantsInstances = { Character, workspace.World.Live, workspace.World.Visuals }
                    or workspace.World.Visuals
        ...
        while Character and Character.Humanoid.Health >= 1 and Character:FindFirstChild("ZenitsuSword") do
            coroutine.resume(coroutine.create(function()
                local Parents = {
                    Character:FindFirstChild("HumanoidRootPart").Position,
                    Character:FindFirstChild("Head").Position,
                    Character:FindFirstChild("Left Arm").Position,
                    Character:FindFirstChild("Right Leg").Position,
                }
    ...
    ["SixFoldTeleport"] = function(Data)
        ...
        for Index = 1, 4 do
            ...
            local Ti5 = TweenInfo.new(0.2, Enum.EasingStyle.Linear, Enum.EasingDirection.Out, 0, false, 0)

            local Tween = TweenService:Create(
                Effect,
                Ti5,
                { ["CFrame"] = CFrame.new(start, End) * CFrame.new(0, 0, -10), ["Size"] = Vector3.new(0, 0, 7.649) }
            )
            Tween:Play()
            Tween:Destroy()
        ...
        coroutine.resume(coroutine.create(function()
            for _ = 1, 4 do
                for Index = 1, 5 do
                    ...
                    local OriginalPosition = CFrame.new(
                    ...
                    InstancedPart.BrickColor = math.random(1, 2) == 1 and BrickColor.new("Pastel blue-green")
                        or BrickColor.new("Cool yellow")
                    InstancedPart.Transparency = 0
                    InstancedPart.CFrame = CFrame.new(
                    ...
                    local Tween = TweenService:Create(
                        ...
                        {
                            ["Size"] = InstancedPart.Size + Vector3.new(0, 0, math.random(1, 2)),
                    ...
                    Debris:AddItem(InstancedPart, 0.15)
                end
                wait(0.15)
            end
        end))
    ...
    ["TransformationOld"] = function(Data)
        ...
        coroutine.resume(coroutine.create(function()
            for Index = 1, 6 do
                ...
                local radiusx, radiusy, radiusz =
                    (math.random(1, 5) * 10) + 10, (math.random(1, 5) * 10) + 10, (math.random(1, 5) * 10) + 10
                ...
                createhugelightning(
                    Root.Position,
                    End,
                    math.clamp((Root.Position - End).Magnitude / 15, 3, 20),
        ...
        if Character and Root and Type then
            for _ = 1, math.random(3, 6) * 3 do
                ...
                Rock.CFrame = Root.CFrame
                    * CFrame.new(x, y, z)
                    * CFrame.new(0, -Character:GetModelSize().Y / 2, 0)
                    * CFrame.Angles(
                        math.rad(math.random(1, 24) * 15),
                        math.rad(math.random(1, 24) * 15),
                        math.rad(math.random(1, 24) * 15)
                    )
                ...
                local Tween =
                    TweenService:Create(Rock, B1, { Position = Rock.Position + Vector3.new(0, (math.random(1, 7)), 0) })
                Tween:Play()
                Tween:Destroy()
                coroutine.resume(coroutine.create(function()
                    wait(1)
            ...
            local B2 = TweenInfo.new(0.1, Enum.EasingStyle.Linear, Enum.EasingDirection.Out, 0, false, 0)
            local B4 = TweenInfo.new(0.2, Enum.EasingStyle.Linear, Enum.EasingDirection.Out, 0, false, 0)

            TweenService
                :Create(Wave, B2, { Size = Vector3.new(15, 30, 15), CFrame = Wave.CFrame * CFrame.new(0, 30 / 2, 0) })
                :Play()
            ...
            coroutine.resume(coroutine.create(function()
                ...
                TweenService:Create(
                    ...
                    B2,
                    {
                        ...
                        CFrame = Wave.CFrame
                            * CFrame.new(0, -30 / 2, 0)
                            * CFrame.Angles(0, math.rad(math.random(10, 24) * 15), 0),
                    }
                ):Play()
            end))
            Debris:AddItem(Wave, 0.2)
        ...
        coroutine.resume(coroutine.create(function()
            for _ = 1, 8 do
                if Start and End then
                    ...
                    for Index = 1, numberofparts do
                        local x, y, z =
                            math.random(-2, 2) * 5 * Type, math.random(-2, 2) * 5 * Type, math.random(-2, 2) * 5 * Type
                        if Index == numberofparts then
                            x = 0
                            y = 0
                            z = 0
                        ...
                        Debris:AddItem(Part, 0.4)
                        lastcf = newcframe.p
                        local Ti4 = TweenInfo.new(0.02, Enum.EasingStyle.Linear, Enum.EasingDirection.Out, 2, true, 0)
    ...
    ["WhirlWindHit"] = function(Data)
        ...
        local _ = Character.Name == Players.LocalPlayer.Name and GlobalFunctions.FreshShake(85, 25, 1, 0.2, 0)
        ...
        Dust.Particle.Size =
            NumberSequence.new({ NumberSequenceKeypoint.new(0, 1.5), NumberSequenceKeypoint.new(1, 3) })
        ...
        Debris:AddItem(GroundDebris, 0.35)
    ...
    ["WhirlWindRelease"] = function(Data)
        ...
        for Index = 1, 9 do
            ...
            local _ = Character.Name == Players.LocalPlayer.Name and GlobalFunctions.FreshShake(100, 30, 1, 0.2, 0)
            ...
            coroutine.resume(coroutine.create(function()
                for _ = 1, 3 do
                    ...
                    Orbie.CFrame = CFrame.new(
                        OriginalPosition + Vector3.new(math.random(-1, 1), math.random(-1, 1), math.random(-1, 1)),
                        OriginalPosition
                    )
                    ...
                    GlobalFunctions.TweenFunction({
                        ...
                        ["Transparency"] = 0.8,
                        ["Size"] = Vector3.new(0, 0, 0.8),
                    })

                    Debris:AddItem(Orbie, 0.35)
                end
            end))
            local Slash = Effects.slash:Clone()
            Slash.Material = "Neon"
            Slash.BrickColor = math.random(1, 2) == 1 and BrickColor.new("Pastel blue-green")
                or BrickColor.new("Cool yellow")
            Slash.Size = Vector3.new(5, 5, 5)
            Slash.CFrame = Root.CFrame
                * CFrame.fromEulerAnglesXYZ(math.random(-360, 360), math.random(-360, 360), math.random(-360, 360))
            ...
            SwingShockwave.Rotation =
                Vector3.new(math.random(-60, 60) * Index, math.random(-60, 60) * Index, math.random(-60, 60) * Index)
            ...
            Debris:AddItem(SwingShockwave, 0.25)

            local Ring = Effects.ring:Clone()
            Ring.BrickColor = math.random(1, 2) == 1 and BrickColor.new("Pastel blue-green")
                or BrickColor.new("Cool yellow")
            Ring.Material = "Neon"
            Ring.Transparency = 0
            ...
            GlobalFunctions.TweenFunction(
                ...
                { ["Size"] = Vector3.new(15, 1, 15), ["CFrame"] = Ring.CFrame * CFrame.fromEulerAnglesXYZ(0, 100, 0) }
            )
            GlobalFunctions.TweenFunction(
                {
                    ["Instance"] = OutRing,
                ...
                { ["Size"] = Vector3.new(30, 1, 30), ["CFrame"] = OutRing.CFrame * CFrame.fromEulerAnglesXYZ(0, 100, 0) }
            )
            ...
            GlobalFunctions.TweenFunction(
                ...
                { ["Transparency"] = 1, ["CFrame"] = Ring.CFrame * CFrame.fromEulerAnglesXYZ(0, 100, 0) }
            )
            GlobalFunctions.TweenFunction(
                {
                    ["Instance"] = OutRing,
                ...
                { ["Transparency"] = 1, ["CFrame"] = OutRing.CFrame * CFrame.fromEulerAnglesXYZ(0, 100, 0) }
            )
            wait(0.15)
        end
    end,
