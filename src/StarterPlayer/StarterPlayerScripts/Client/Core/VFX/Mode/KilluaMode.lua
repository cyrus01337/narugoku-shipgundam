...
local Godspeed = {
	...
	["Transformation"] = function(Data)
		...
		VfxHandler.FakeBodyPart({Character = Character,Object = "Left Leg", Material = "Neon",Color = Color3.fromRGB(110, 153, 202),Transparency = 1,Duration = 2,Delay = .1})
		VfxHandler.FakeBodyPart({Character = Character,Object = "Left Arm", Material = "Neon",Color = Color3.fromRGB(110, 153, 202),Transparency = 1,Duration = 2,Delay = .1})
		VfxHandler.FakeBodyPart({Character = Character,Object = "Torso", Material = "Neon",Color = Color3.fromRGB(110, 153, 202), Transparency = 1,Duration = 2,Delay = .1})
		VfxHandler.FakeBodyPart({Character = Character,Object = "Right Leg", Material = "Neon",Color = Color3.fromRGB(110, 153, 202),Transparency = 1,Duration = 2,Delay = .1})
		VfxHandler.FakeBodyPart({Character = Character,Object = "Right Arm", Material = "Neon",Color = Color3.fromRGB(110, 153, 202), Transparency = 1,Duration = 2,Delay = .1})

		local MainAttachment = Character["Torso"]:FindFirstChild("BodyFrontAttachment")

		local ModeDebris = GlobalFunctions.NewInstance("Folder",{Parent = workspace.World.Visuals.Mode, Name = Character.Name.." Mode Debris"})
		...
		if RaycastResult and RaycastResult.Instance then
			...
			for Index = 1,10 do
				...
				TaskScheduler:AddTask(.15,function() Block.CanCollide = true end)
		...
		for _,v in ipairs(Character:GetChildren()) do
			...
			elseif v:IsA("Accessory") and v.Name == "Hair" then	
				...
				Ting["killua hair"].Transparency = .5
				Ting["killua hair"].Size = v.Handle["killua hair"].Size + Vector3.new(.175,.175,.175) 
				Ting["killua hair 2"].Size = v.Handle["killua hair 2"].Size + Vector3.new(.175,.175,.175) 
				Ting["killua hair 2"].Color = Color3.fromRGB(183, 230, 255)
				Ting["killua hair 2"].Material = "Neon"
				Ting["killua hair 2"].Transparency = .5
		...
		VfxHandler.FakeBodyPart({Character = Character, Name = Character.Name.."GodspeedPart", Object = "Left Arm", Color = Color3.fromRGB(110, 153, 202), Transparency = .6})
		VfxHandler.FakeBodyPart({Character = Character, Name = Character.Name.."GodspeedPart", Object = "Right Arm", Color = Color3.fromRGB(110, 153, 202), Transparency = .6})
		VfxHandler.FakeBodyPart({Character = Character, Name = Character.Name.."GodspeedPart", Object = "Torso", Color = Color3.fromRGB(110, 153, 202), Transparency = .6})
		VfxHandler.FakeBodyPart({Character = Character, Name = Character.Name.."GodspeedPart", Object = "Left Leg", Color = Color3.fromRGB(110, 153, 202), Transparency = .6})
		VfxHandler.FakeBodyPart({Character = Character, Name = Character.Name.."GodspeedPart", Object = "Right Leg", Color = Color3.fromRGB(110, 153, 202), Transparency = .6})	
		...
		Clone.Size = PlayerHead.Size + Vector3.new(.1,.1,.1)
		Clone.Transparency = .35
		...
		while Character and Players:GetPlayerFromCharacter(Character) and Character.Humanoid.Health >= 1 and _G.Data.Character == "Killua" do
			coroutine.resume(coroutine.create(function()
				local Parents = {Character:FindFirstChild("HumanoidRootPart"), Character:FindFirstChild("Head"), Character:FindFirstChild("Left Arm"), Character:FindFirstChild("Right Leg")}

				local Attachment = Instance.new("Attachment")
				Attachment.Position = Vector3.new(.5,.5,.5);
