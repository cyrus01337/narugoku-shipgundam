...
return function(Damage)
	...
	if not Player.PlayerGui:FindFirstChild("HitIndicator") then
		...
		hitIndicator.Frame:TweenSize(UDim2.fromScale(0.101, 0.122), Enum.EasingDirection.Out, Enum.EasingStyle.Back, 0.2, true)

		hitIndicator.Frame.Hits.Text = currentHitCount .. " HITS!"
		hitIndicator.Frame.Hits:TweenSize(UDim2.fromScale(0.813 * 1.1, 0.339 * 1.1), Enum.EasingDirection.Out, Enum.EasingStyle.Back, 0.06, true)
		task.delay(0.06, function()
			if hitIndicator.Frame.Hits.Size == UDim2.fromScale(0.813 * 1.1, 0.339 * 1.1) then
				hitIndicator.Frame.Hits:TweenSize(UDim2.fromScale(0.813, 0.339), Enum.EasingDirection.Out, Enum.EasingStyle.Back, 0.06, true)
			end
		end)
		...
		hitIndicator.Frame.Damage:TweenSize(UDim2.fromScale(0.813 * 1.1, 0.339 * 1.1), Enum.EasingDirection.Out, Enum.EasingStyle.Back, 0.06, true)
		task.delay(0.06, function()
			if hitIndicator.Frame.Damage.Size == UDim2.fromScale(0.813 * 1.1, 0.339 * 1.1) then
				hitIndicator.Frame.Damage:TweenSize(UDim2.fromScale(0.813, 0.339), Enum.EasingDirection.Out, Enum.EasingStyle.Back, 0.06, true)
			end
		end)
