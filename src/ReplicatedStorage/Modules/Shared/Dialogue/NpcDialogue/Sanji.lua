...
return {
    Title = "Sanji",
    Text = {
        "<AnimateStyle=Wiggle><AnimateStyleAmplitude=.7><AnimateStyleNumPeriods=1><AnimateStepFrequency=1><AnimateStyleTime=.15><AnimateStepTime=.001><TextScale=.125>Why 'ello there ! since you made you're way here I assume you want to learn more about<AnimateStyle=Rainbow><AnimateStyleTime=1> nen?<AnimateStyleTime=/><AnimateStyle=/><TextScale=/><AnimateStepTime=/><AnimateStyleTime=/><AnimateStepFrequency=/><AnimateStyleNumPeriods=/><AnimateStyleAmplitude=/><AnimateStyle=/><TextScale=/><AnimateStepTime=/><AnimateStyleTime=/><AnimateStepFrequency=/><AnimateStyleNumPeriods=/><AnimateStyleAmplitude=/><AnimateStyle=/>",
    },
    ...
    ["FirstNode"] = {
        ...
        Option2 = {
            InitialText = "",
            PressedOn = function(CurrentNode, DialogueModule) end,
        },
        Option3 = {
            InitialText = "",
            PressedOn = function(CurrentNode, DialogueModule) end,
    ...
    ["SecondNode"] = {
        ...
        Option1 = {
            ...
            PressedOn = function(Player, CurrentNode, DialogueModule) end,
        },
