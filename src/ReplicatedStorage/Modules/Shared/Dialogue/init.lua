...
local DialogueIn = TweenService:Create(Dialogue,TweenInfo.new(.5,Enum.EasingStyle.Quart,Enum.EasingDirection.Out),{Size = UDim2.new(1,0,0.25,0),BackgroundTransparency = 0.6})
local DialogueOut = TweenService:Create(Dialogue,TweenInfo.new(.5,Enum.EasingStyle.Quart,Enum.EasingDirection.Out),{Size = UDim2.new(0.4,0,0.1,0),BackgroundTransparency = 1})
local TitleIn = TweenService:Create(title,TweenInfo.new(.5,Enum.EasingStyle.Quart,Enum.EasingDirection.Out),{TextTransparency = 0,TextStrokeTransparency = 0.6})
local TitleOut = TweenService:Create(title,TweenInfo.new(.5,Enum.EasingStyle.Quart,Enum.EasingDirection.Out),{TextTransparency = 1,TextStrokeTransparency = 1.5})

local slideInDialogue = TweenService:Create(Dialogue,TweenInfo.new(.5,Enum.EasingStyle.Quart,Enum.EasingDirection.Out),{Position = UDim2.new(0.43,0,0.7,0)})
local slideOutDialogue = TweenService:Create(Dialogue,TweenInfo.new(.5,Enum.EasingStyle.Quart,Enum.EasingDirection.Out),{Position = UDim2.new(0.5,0,0.7,0)})

--ButtonFadeIn--
local ButtonFadeIn1 = TweenInfo.new(.3,Enum.EasingStyle.Quart,Enum.EasingDirection.Out)
local ButtonFadeIn2 = TweenInfo.new(.2,Enum.EasingStyle.Quart,Enum.EasingDirection.Out)

--ButtonFadeOut--
local ButtonFadeOut1 = TweenInfo.new(.2,Enum.EasingStyle.Quart,Enum.EasingDirection.Out)
local ButtonFadeOut2 = TweenInfo.new(.2,Enum.EasingStyle.Quart,Enum.EasingDirection.Out)
...
local function ButtonFadeIn(TextButton, Info)
	local ButtonFadeInTween = TweenService:Create(TextButton, ButtonFadeIn1, {Size = UDim2.new(0.35, 0, 0.4, 0),BackgroundTransparency = 0.6})
...
local function ButtonFadeOut(TextButton, Info)
	local ButtonFadeOutTween = TweenService:Create(TextButton, ButtonFadeOut1, {Size = UDim2.new(0, 0, 0.4, 0),BackgroundTransparency = 1})
...
function DialogueModule.Start(DialogueData)
	...
	BindOption1Connection = Option1.MouseButton1Down:Connect(function()
		local ResultFunction, Output = NpcDialogueData[CurrentNode.."Node"].Option1.PressedOn(Player, CurrentNode,DialogueModule)
	...
	BindOption2Connection = Option2.MouseButton1Down:Connect(function()
		local ResultFunction, Output = NpcDialogueData[CurrentNode.."Node"].Option2.PressedOn(Player, CurrentNode,DialogueModule)
	...
	BindOption3Connection = Option3.MouseButton1Down:Connect(function()
		local ResultFunction, Output = NpcDialogueData[CurrentNode.."Node"].Option3.PressedOn(Player, CurrentNode,DialogueModule)
