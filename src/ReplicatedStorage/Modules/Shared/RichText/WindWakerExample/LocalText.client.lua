...
local buttonClickTween = tweenService:Create(
    buttonA,
    TweenInfo.new(0.05, Enum.EasingStyle.Quart, Enum.EasingDirection.InOut),
    { Size = UDim2.new(0.25, 0, 0.25, 0) }
)
local frameFadeIn =
    tweenService:Create(dialogueFrame, TweenInfo.new(0.4), { Size = dialogueFrame.Size, ImageTransparency = 0 })
...
local textSequence = {
    {
        Text = "I just saw a <Color=Red>wild<Color=/>...a <AnimateStyle=Wiggle><Color=Red>wild pig🐷<Color=/>!<AnimateYield=1><AnimateStyle=/>\nOoh! See? Look! That black one there...<AnimateYield=1>\nDon't you see him?",
        Delay = 1.5,
    },
    {
