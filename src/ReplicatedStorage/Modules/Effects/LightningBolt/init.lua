...
function LightningBolt.new(Attachment0, Attachment1, PartCount)
    ...
    self.CurveSize0, self.CurveSize1 = 4, 4 --Works similarly to beams. See https://dk135eecbplh9.cloudfront.net/assets/blt160ad3fdeadd4ff2/BeamCurve1.png
    ...
    self.AnimationSpeed = 1 --Governs how fast the bolt oscillates (i.e. how fast the fluctuating wave travels along bolt)
    self.Thickness = 0.4 --The thickness of the bolt
    ...
    self.PulseSpeed = 16 --Bolt arrives at Attachment1 1/PulseSpeed seconds later. See https://www.desmos.com/calculator/hg5h4fpfim
    self.PulseLength = 2 --See https://www.desmos.com/calculator/hg5h4fpfim
    ...
    local p0, p1, p2, p3 =
        a0.WorldPosition,
        a0.WorldPosition + a0.WorldAxis * self.CurveSize0,
        a1.WorldPosition - a1.WorldAxis * self.CurveSize1,
        a1.WorldPosition
