...
return function(Data)
    ...
    for j = 1, j do
        for i = 1, i do
            ...
            Block.CFrame =
                CFrame.new(StartPos + Vector3.new(math.random(-1, 1), math.random(-1, 1), math.random(-1, 1)), StartPos)

            if EndPos and Range then
                Block.CFrame = CFrame.lookAt(
                    StartPos,
                    EndPos
                        + Vector3.new(
            ...
            local tween = TweenService:Create(
                ...
                { ["Size"] = Block.Size + Vector3.new(0, 0, math.random(2, 5)), ["CFrame"] = Block.CFrame * Distance }
            )
