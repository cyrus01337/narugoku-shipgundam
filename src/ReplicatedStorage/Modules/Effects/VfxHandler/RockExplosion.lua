...
return function(Data)
    ...
    for i = 1, #Points do
        ...
        local Result = RayService:Cast(
            ...
            CF.Position - Vector3.new(0, 10, 0),
            { workspace.World.Visuals, workspace.World.Visuals },
        ...
        if Result then
            ...
            Rock.CFrame = CFrame.new(Result.Position - Vector3.new(0, Size.Y / 2, 0))
    ...
    delay(Duration, function()
        for i = 1, #RocksCache do
            ...
            local Animate =
                TweenService:Create(Rock, TweenInfo.new(1, Enum.EasingStyle.Linear, Enum.EasingDirection.Out), Goal)
            Animate:Play()
            Animate:Destroy()
