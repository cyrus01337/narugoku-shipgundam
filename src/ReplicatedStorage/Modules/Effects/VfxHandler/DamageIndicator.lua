...
local Ti22 = TweenInfo.new(0.16, Enum.EasingStyle.Quad, Enum.EasingDirection.Out, 0, true, 0)
...
return function(Victim, DamageAmount)
    ...
    local Tween = TweenService:Create(
        DamageIndicator.Bill.T1:FindFirstChild("Text"),
        Ti22,
        { TextColor3 = Color3.fromRGB(162, 234, 255) }
    )
    Tween:Play()
    Tween:Destroy()

    Debris:AddItem(DamageIndicator, 0.5)
