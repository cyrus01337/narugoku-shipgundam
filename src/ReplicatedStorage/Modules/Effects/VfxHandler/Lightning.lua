...
return function(Data)
	...
	for Index = 1, Data.Amount do
		local offset = Vector3.new(math.random(-Data.OffsetRange,Data.OffsetRange), math.random(-3,3), math.random(-Data.OffsetRange,Data.OffsetRange))
		local Position = Data.StartPosition + (Data.EndPosition - Data.StartPosition).Unit * Index * (Data.EndPosition - Data.StartPosition).Magnitude / Data.Amount + offset
