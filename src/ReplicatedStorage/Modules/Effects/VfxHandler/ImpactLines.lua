	...
	if Character then
		coroutine.resume(coroutine.create(function()
			for Index = 1,Amount do
				...
				Part.Position = Character.PrimaryPart.Position + Vector3.new(0,2,0) + Vector3.new(RNG:NextNumber(-4,4),RNG:NextNumber(-7,4),RNG:NextNumber(-4,4))
				...
				local Tween = TweenService:Create(Part,TI2,{Position = Part.Position + Part.CFrame.lookVector * - RNG:NextNumber(-5,-Amount),Transparency = 1;Size = Part.Size/2})
				Tween:Play()
				Tween:Destroy()
