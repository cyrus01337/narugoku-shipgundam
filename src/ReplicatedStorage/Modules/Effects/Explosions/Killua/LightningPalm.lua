...
return function(Data)
	...
	LightningExplosion.new(Character.HumanoidRootPart.Position, .5, 14, ColorSequence.new(Color3.fromRGB(143, 212, 255)), ColorSequence.new(Color3.fromRGB(117, 237, 255)), nil)
