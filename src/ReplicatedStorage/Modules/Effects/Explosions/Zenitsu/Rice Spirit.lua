...
return function(Data)
	...
	for Index = 1, math.random(5,7) do
		...
		TweenService:Create(slash,B5,{Transparency = 1,CFrame = slash.CFrame * CFrame.Angles(math.pi * add,0,0),Size = slash.Size + Vector3.new(0,sizeadd,sizeadd)}):Play()
