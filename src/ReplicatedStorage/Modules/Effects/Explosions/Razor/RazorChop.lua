...
return function(Data)
    ...
    for _ = 1, math.random(6, 8) do
        ...
        local OrbieTweenInfo = TweenInfo.new(0.75, Enum.EasingStyle.Linear, Enum.EasingDirection.Out, 0, false, 0)
    ...
    for _ = 1, 2 do
        ...
        local Tween = TweenService:Create(
            Ring,
            RingTween,
            { CFrame = Ring.CFrame * CFrame.new(0, 12, 0), Size = Vector3.new(0, 0, 0) }
        )
        Tween:Play()
        Tween:Destroy()
