...
return function(Data)
    ...
    LightningExplosion.new(
        ...
        5,
        10,
        ColorSequence.new(Color3.fromRGB(255, 82, 39)),
    ...
    GlobalFunctions.TweenFunction(
        ...
        { ["CFrame"] = Ring.CFrame * CFrame.new(0, 12, 0), ["Transparency"] = 1, ["Size"] = Vector3.new(25, 0.05, 25) }
    )
    ...
    local Number, Orbie = VfxHandler.Orbies({
        Parent = Result,
        Speed = 0.5,
        Size = Vector3.new(2, 2, 30),
    ...
    for _ = 1, 2 do
        ...
        local Spin = TweenService:Create(
            Shockwave,
            TweenInfo.new(0.5, Enum.EasingStyle.Quad, Enum.EasingDirection.Out, -1),
        ...
        local Pillow = TweenService:Create(
            Shockwave,
            TweenInfo.new(0.5 + math.random(), Enum.EasingStyle.Bounce, Enum.EasingDirection.Out, 0, false, 0),
    ...
    coroutine.resume(coroutine.create(function()
        for _ = 1, 2 do
            ...
            GlobalFunctions.TweenFunction(
                ...
                {
                    ["Size"] = Vector3.new(35, 2, 35),
                    ["Transparency"] = 1,
                    ["CFrame"] = Shockwave.CFrame * CFrame.fromEulerAnglesXYZ(0, 5, 0),
                }
            )
            wait(0.1)
        end
    ...
    GlobalFunctions.TweenFunction(
        ...
        {
            ["CFrame"] = ShockwaveTing.CFrame * CFrame.new(0, 50, 0) * CFrame.fromEulerAnglesXYZ(0, 5, 0),
            ["Transparency"] = 1,
            ["Size"] = Vector3.new(0, 180, 0),
        }
    )

    Debris:AddItem(ShockwaveTing, 0.5)

    for _ = 1, 3 do
        local ShockWave = Effects.shockwave3:Clone()
        ShockWave.Position = Result.Position
        ShockWave.Mesh.Scale = Vector3.new(0.1, 0.1, 0.1)
    ...
    for Index = 1, 2 do
        ...
        GlobalFunctions.TweenFunction(
            ...
            { ["Transparency"] = 1, ["Size"] = Vector3.new(50, 1, 50) }
        )
