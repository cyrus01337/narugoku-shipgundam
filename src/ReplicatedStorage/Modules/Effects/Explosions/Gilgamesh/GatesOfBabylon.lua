...
return function(Data)
    ...
    coroutine.resume(coroutine.create(function()
        for _ = 1, 2 do
            ...
            local Tween = TweenService:Create(
                Ring,
                RingTween,
                { CFrame = Ring.CFrame * CFrame.new(0, 25, 0), Size = Vector3.new(0, 0, 0) }
            )
            Tween:Play()
            Tween:Destroy()
    ...
    local _ = Data.Type == nil
        and LightningExplosion.new(
            Result.Position,
            0.15,
            1,
            ColorSequence.new(Color3.fromRGB(255, 232, 140)),
            ColorSequence.new(Color3.fromRGB(255, 241, 33)),
            nil
        )
    if Data.Type == "Punishment" then
        ...
        local Tween = TweenService:Create(
            ...
            { ["Size"] = Vector3.new(8.5, 8.5, 8.5), ["Transparency"] = 1 }
        )
        Tween:Play()
        Tween:Destroy()
