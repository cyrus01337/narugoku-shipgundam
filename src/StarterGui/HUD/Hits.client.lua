    ...
    Hits.Changed:Connect(function()
        if Hits.Value ~= 0 then
            if script.Parent:FindFirstChild("EffectFrame") then
                local Tween =
                    TweenService:Create(script.Parent.EffectFrame, Ti3, { Size = UDim2.new(0.134, 0, 0.186, 0) })
                Tween:Play()
                Tween:Destroy()
            end
            ...
            if script.Parent:FindFirstChild("EffectFrame") then
                ...
                if script.Parent.EffectFrame:FindFirstChild("Number") then
                    ...
                    script.Parent.EffectFrame.BarTing.Bar:TweenSize(
                        UDim2.new(0, 8, 0, 4),
                    ...
                    local Tween = TweenService:Create(
                        script.Parent.EffectFrame.BarTing.Bar,
                        Ti2,
