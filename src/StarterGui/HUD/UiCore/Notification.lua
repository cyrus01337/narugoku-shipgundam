...
function Notification.Initiate(Data)
    ...
    ItemUi:TweenPosition(
        UDim2.new(0.421, 0, (math.clamp(0.218 + (RewardCounter * 0.05), 0.1, 0.8)), 0),
    ...
    task.spawn(function()
        ...
        local CalculateSide = math.random(1, 2) == 0.75 and 0.75 or -0.75

        ItemUi:TweenPosition(
            UDim2.new(CalculateSide, 0, (math.clamp(0.218 + (RewardCounter * 0.05), 0.21, 0.8)), 0),
            Enum.EasingDirection.Out,
