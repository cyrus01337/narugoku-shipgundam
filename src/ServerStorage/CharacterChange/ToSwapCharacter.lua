...
return function(Data)
	...
	if not Player or Character == nil then return end
	...
	if not CharacterToSwap then warn(Character,"is not a valid character model in ServerStorage > Characters") return end
