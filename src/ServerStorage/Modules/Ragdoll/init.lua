...
function module.DurationRagdoll(Target, Duration, Knockout)
    coroutine.resume(coroutine.create(function()
        ...
        local Adoornments = {}
        local BodyParts = {
            Target:FindFirstChild("Right Arm"),
            Target:FindFirstChild("Left Arm"),
            Target:FindFirstChild("Right Leg"),
            Target:FindFirstChild("Left Leg"),
            Target["Head"],
        }
        ...
        local function CreateAdoornments()
            for _, BodyPart in pairs(BodyParts) do
                ...
                elseif BodyPart.Name == "Right Leg" then
                    Attachment0.CFrame = CFrame.new(0, BodyPart.Size.Y / 2, 0)
                    Attachment1.CFrame = Attachment0.CFrame * CFrame.new(0.5, -BodyPart.Size.Y, 0)
