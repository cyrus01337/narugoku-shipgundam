...
return function(Player, Request, Character, Datastore, Type) -- Player:Instance, Character:String, Data:Table
    ...
    if Type == "Select" and Data.Unlocked[Character] then
        ...
        player:WaitForChild("Mode", 60).Value = 0
        ...
        local _ = CharacterInfo[Data.Character]["HasBar"]
            and CameraRemote:FireClient(Player, "HideCharacterBar", { Character = Data.Character })
    ...
    if
        Data
        and not Data.Unlocked[Character]
        and Data.Cash >= CharacterInfo[Character]["Cost"]
        and Type == "Purchase"
    then
    ...
    elseif Data and not Data.Unlocked[Character] and Data.Cash <= CharacterInfo[Character]["Cost"] then
        ...
        GUIRemote:FireClient(Player, "Notification", {
            ...
            Text = (
                "<font color= 'rgb(%s, %s, %s)'>&lt; "
                .. WarningText
                .. "&gt;</font> need more before unlocking this character."
            ),
        })
    end
end
