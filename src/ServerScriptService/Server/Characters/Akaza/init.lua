...
local Akaza = {
	...
	["FirstAbility"] = function(Player,CharacterName,KeyData,MoveData,ExtraData)
		...
		if PlayerCombo.KeysLogged >= 3 then
			...
			if HitResult then
				...
				NetworkStream.FireClientDistance(Character,"ClientRemote",200,{Character = Character, Distance = 100, Victim = Victim, Module = "AkazaVFX", Function = "Fire Dragon's Iron Fist"})	
	...
	["SecondAbility"] = function(Player,CharacterName,KeyData,MoveData,ExtraData)
		...
		NetworkStream.FireClientDistance(Character,"ClientRemote",200,{Character = Character, Distance = 100, Module = "AkazaVFX", Function = "CrimsonLotusStart"})
		...
		local function NoContact()
			...
			NetworkStream.FireClientDistance(Character,"ClientRemote",200,{Character = Character, ContactPoint = Direction, Distance = 100, Module = "AkazaVFX", Function = "CrimsonLotusLand"})
		end
		...
		if ray then
			...
			if partHit then
				...
				NetworkStream.FireClientDistance(Character,"ClientRemote",10,{Character = Character, Distance = 10, Module = "AkazaVFX", Function = "AkazaScreen"})

				--[[ Fire Found Landing Effects ]]--
				BodyPosition:Destroy()
				NetworkStream.FireClientDistance(Character,"ClientRemote",200,{Character = Character, Distance = 100, ContactPoint = pos, Module = "AkazaVFX", Function = "CrimsonLotusLand"})
			end
		end
	...
	["ThirdAbility"] = function(Player,CharacterName,KeyData,MoveData,ExtraData)
		...
		--[[ Fire Client ]]
		NetworkStream.FireClientDistance(Character,"ClientRemote",200,{Character = Character, Distance = 100, ContactPoint = Root.CFrame, Module = "AkazaVFX", Function = "PurgatoryDragonFire"})
		wait(1)
	...
	["FourthAbility"] = function(Player,CharacterName,KeyData,MoveData,ExtraData)
		...
		if StateManager:Peek(Character,"Stunned") then return end
		--[[ Fire Client ]]
		NetworkStream.FireClientDistance(Character,"ClientRemote",200,{Character = Character, Distance = 100, ContactPoint = Root.CFrame, Module = "AkazaVFX", Function = "FireDragonRoar"})
