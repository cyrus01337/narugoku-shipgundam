...
local Itachi = {
    ...
    ["ThirdAbility"] = function(Player, CharacterName, KeyData, MoveData, ExtraData, Modules)
        ...
        if ItachiData.StoredSkill == "" then
            ...
            if
                ItachiData.CopiedSkillData
                and ItachiData.CopiedSkillData.Copyable
                and ItachiData.CopiedSkillData.Copyable == true
            then
            ...
            CacheModule(Player, ItachiData.SharinganContact, {
                ...
                KeyName = ItachiData.StoredSkill == "FirstAbility" and "Z"
                    or ItachiData.StoredSkill == "SecondAbility" and "X"
                    or ItachiData.StoredSkill == "ThirdAbility" and "C"
                    or "V",
            }, SkillData, ExtraData)
    ...
    ["FourthAbility"] = function(Player, CharacterName, KeyData, MoveData, ExtraData)
        ...
        NetworkStream.FireClientDistance(
            ...
            "ClientRemote",
            200,
            { Character = Character, Module = "ItachiVFX", Function = "Shuriken" }
        )
