...
local Pain = {
    ["FirstAbility"] = function(Player, CharacterName, KeyData, MoveData, ExtraData)
        ...
        NetworkStream.FireClientDistance(
            ...
            "ClientRemote",
            200,
            { Character = Character, Module = "PainVFX", Function = "Push" }
        )
    end,
    ...
    ["SecondAbility"] = function(Player, CharacterName, KeyData, MoveData, ExtraData)
        ...
        NetworkStream.FireClientDistance(
            ...
            "ClientRemote",
            200,
            { Character = Character, Module = "PainVFX", Function = "Al~Shamac" }
        )
            ...
            if HitResult then
                ...
                for Index = 1, #ValidEntities do
                    ...
                    NetworkStream.FireClientDistance(
                        ...
                        "ClientRemote",
                        200,
                        { Character = Character, Victim = Victim, Module = "PainVFX", Function = "shamac~hit" }
                    )
                    ...
                    NetworkStream.FireClientDistance(
                        ...
                        "ClientRemote",
                        200,
                        { Character = Character, Victim = Victim, Module = "PainVFX", Function = "brekapart" }
                    )
                end
            end
        end)
    ...
    ["ThirdAbility"] = function(Player, CharacterName, KeyData, MoveData, ExtraData)
        ...
        NetworkStream.FireClientDistance(
            ...
            "ClientRemote",
            200,
            { Character = Character, Module = "PainVFX", Function = "cast shield" }
        )
        ...
        local function RemoveBall()
            NetworkStream.FireClientDistance(
                ...
                "ClientRemote",
                200,
                { Character = Character, Module = "PainVFX", Function = "removbal" }
            )
