...
local Beatrice = {
	["FirstAbility"] = function(Player,CharacterName,KeyData,MoveData,ExtraData)
		...
		NetworkStream.FireClientDistance(Character, "ClientRemote", 200, {Character = Character, Module = "BeatriceVFX", Function = "Push"})	
	end,
		...
		TaskScheduler:AddTask(1.65,function()
			...
			if HitResult then
				...
				for Index = 1, #ValidEntities do
					...
					NetworkStream.FireClientDistance(Character, "ClientRemote", 200, {Character = Character, Victim = Victim,  Module = "BeatriceVFX", Function = "brekapart"})
				end
			end
		end)
	end,
...
--		SpeedManager.changeSpeed(Character,2,4,3.5)
	...
	["FourthAbility"] = function(Player,CharacterName,KeyData,MoveData,ExtraData)
		...
		for Index = 1,3 do
			...
			NetworkStream.FireClientDistance(Character,"ClientRemote",200,{Character = Character, Victim = Victim, Distance = 100, Module = "BeatriceVFX", Function = "bezierballs", WhichBall = ChosenBall})		
