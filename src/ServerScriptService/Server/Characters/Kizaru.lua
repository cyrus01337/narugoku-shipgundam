...
local Kizaru = {
    ["FirstAbility"] = function(Player, CharacterName, KeyData, MoveData, ExtraData)
        ...
        NetworkStream.FireClientDistance(
            ...
            "ClientRemote",
            200,
            { Character = Character, Module = "KizaruVFX", Function = "WaterStuff", Duration = 0.35 }
        )
        NetworkStream.FireClientDistance(
            Character,
            "ClientRemote",
            200,
            { Character = Character, Module = "KizaruVFX", Function = "Trail", Sword = Sword, Duration = 0.6 }
        )
        ...
        NetworkStream.FireClientDistance(
            ...
            "ClientRemote",
            200,
            { Character = Character, Module = "KizaruVFX", Function = "WaterSurfaceSlash", Sword = Sword }
        )
    ...
    ["SecondAbility"] = function(Player, CharacterName, KeyData, MoveData, ExtraData)
        ...
        NetworkStream.FireClientDistance(
            ...
            "ClientRemote",
            200,
            { Character = Character, Module = "KizaruVFX", Function = "WaterStuff", Duration = 0.5 }
        )
        ...
        NetworkStream.FireClientDistance(
            ...
            "ClientRemote",
            200,
            { Character = Character, Module = "KizaruVFX", Function = "secondform" }
        )
    ...
    ["ThirdAbility"] = function(Player, CharacterName, KeyData, MoveData, ExtraData)
        ...
        NetworkStream.FireClientDistance(
            ...
            "ClientRemote",
            200,
            { Character = Character, Distance = 100, Enemy = Victim, Module = "KizaruVFX", Function = "Light" }
        )
        wait(0.75)
        ...
        NetworkStream.FireClientDistance(
            ...
            "ClientRemote",
            5,
            { Character = Character, Distance = 100, Module = "KizaruVFX", Function = "HieiScreen" }
        )
