...
local SanjiMode = {
    ...
    ["Transformation"] = function(Player, CharacterName, KeyData, MoveData, ExtraData)
        ...
        NetworkStream.FireClientDistance(
            ...
            "ClientRemote",
            350,
            { Character = Character, Module = "SanjiVFX", Function = "Transformation" }
        )
    ...
    ["FirstAbility"] = function(Player, CharacterName, KeyData, MoveData, ExtraData)
        ...
        NetworkStream.FireClientDistance(
            ...
            "ClientRemote",
            150,
            { Character = Character, Module = "SanjiModeVFX", Function = "PartyTable" }
        )
        for Index = 1, 15 do
    ...
    ["SecondAbility"] = function(Player, CharacterName, KeyData, MoveData, ExtraData)
        ...
        if HitResult then
            ...
            NetworkStream.FireClientDistance(
                ...
                "ClientRemote",
                150,
                { Character = Character, Module = "SanjiModeVFX", Function = "Anti_Manner_Kick_Course" }
            )
    ...
    ["ThirdAbility"] = function(Player, CharacterName, KeyData, MoveData, ExtraData)
        ...
        NetworkStream.FireClientDistance(
            ...
            "ClientRemote",
            150,
            { Character = Character, Module = "SanjiModeVFX", Function = "Spectre" }
        )
        ...
        for Index = 1, 15 do
            ...
            if HitObject.Hit then
                ...
                local _ = Index == 15
                    and VfxHandler.FireProc({ Character = Character, Victim = Victim, Damage = 1, Duration = 3 })
            end
            wait(0.1)
        end
    ...
    ["FourthAbility"] = function(Player, CharacterName, KeyData, MoveData, ExtraData)
        ...
        Debris:AddItem(BodyVelocity, 0.425)
        ...
        NetworkStream.FireClientDistance(
            ...
            "ClientRemote",
            150,
            { Character = Character, Module = "SanjiModeVFX", Function = "SetDash" }
        )
        NetworkStream.FireClientDistance(
            Character,
            "ClientRemote",
            150,
            { Character = Character, Module = "SanjiModeVFX", Function = "AscendTrail" }
        )
        ...
        NetworkStream.FireClientDistance(
            ...
            "ClientRemote",
            150,
            { Character = Character, Victim = Victim, Module = "SanjiModeVFX", Function = "TeleportKick" }
        )
        ...
        BodyGyro.CFrame = CFrame.lookAt(
            ...
            Victim:FindFirstChild("HumanoidRootPart").Position + Vector3.new(0, 2, 0)
        )
        ...
        NetworkStream.FireClientDistance(
            ...
            "ClientRemote",
            150,
            { Character = Character, Module = "SanjiModeVFX", Function = "AscendKick" }
        )
        NetworkStream.FireClientDistance(
            Character,
            "ClientRemote",
            150,
            { Character = Character, Victim = Victim, Module = "SanjiModeVFX", Function = "DemonAxeExplode" }
        )
        ...
        NetworkStream.FireClientDistance(
            ...
            "ClientRemote",
            150,
            { Character = Character, Victim = Victim, Module = "SanjiModeVFX", Function = "FLASHKICKHITTTTT" }
        )
