...
local AokijiMode = {
        ...
        if Hits and Hits.Value >= 1 then
            ...
            if HitResult then
                ...
                NetworkStream.FireClientDistance(
                    ...
                    "ClientRemote",
                    200,
                    { Character = Character, Victim = Victim, Module = "AokijiMode", Function = "FreezingGrab" }
                )
    ...
    ["SecondAbility"] = function(Player, CharacterName, KeyData, MoveData, ExtraData)
        ...
        NetworkStream.FireClientDistance(
            ...
            "ClientRemote",
            500,
            { Character = Character, Module = "AokijiMode", Function = "Ice Bird" }
        )
    ...
    ["ThirdAbility"] = function(Player, CharacterName, KeyData, MoveData, ExtraData)
        ...
        if Root:FindFirstChild("IceSlide") then
            return
        end
        ...
        NetworkStream.FireClientDistance(
            ...
            "ClientRemote",
            500,
            { Character = Character, Module = "AokijiMode", Function = "Ice Slide" }
        )
        ...
        while BodyVelocity and RunService.Stepped:Wait() do
            ...
            if
                Root:FindFirstChild("IceSlide") == nil
    ...
    ["FourthAbility"] = function(Player, CharacterName, KeyData, MoveData, ExtraData)
        ...
        NetworkStream.FireClientDistance(
            ...
            "ClientRemote",
            400,
            { Character = Character, Module = "AokijiMode", Function = "Ice Age" }
        )
        ...
        local HitResult, ValidEntities = HitboxModule.GetTouchingParts(
            Player,
            {
                ExistTime = 2,
                Type = "Combat",
                Size = Vector3.new(88.719, 48.896, 85.933),
                Transparency = 1,
