...
local Yami = {
	["FirstAbility"] = function(Player,CharacterName,KeyData,MoveData,ExtraData)
		...
		--[[ Slash Charge Up ]]--
		NetworkStream.FireClientDistance(Character,"ClientRemote",200,{Character = Character, Distance = 100, Module = "YamiVFX", Function = "AvidyaSlashCharge"})
		...
		coroutine.resume(coroutine.create(function()
			...
			RaycastManager:CastProjectileHitbox({
				...
				Function = function(RaycastResult)
					local ValidEntities = RaycastManager:GetEntitiesFromPoint(RaycastResult.Position, workspace:GetChildren(), {[Character] = true}, 15)
			...
			--[[ Slash Charge Up ]]--
			NetworkStream.FireClientDistance(Character, "ClientRemote", 200, {Character = Character, Module = "YamiVFX", Function = "YamiSlash", StartPoint = StartPoint, MouseHit = MouseHit, Lifetime = Lifetime, Velocity = Velocity, Distance = 100, Direction = Direction, Ponts = Points})
			NetworkStream.FireClientDistance(Character,"ClientRemote",200,{Character = Character, Distance = 10, Module = "YamiVFX", Function = "YamiScreen"})
	...
	["SecondAbility"] = function(Player,CharacterName,KeyData,MoveData,ExtraData)
		...
		--[[ Fire Client ]]--
		NetworkStream.FireClientDistance(Character,"ClientRemote",200,{Character = Character, Distance = 100, Module = "YamiVFX", Function = "DarkBinding"})
		--[[ Screen Shake ]]--
		CameraRemote:FireClient(Player,"CameraShake",{
			FirstText = 6,
			SecondText = 12
	...
	["ThirdAbility"] = function(Player,CharacterName,KeyData,MoveData,ExtraData)
		...
		NetworkStream.FireClientDistance(Character, "ClientRemote", 200, {Character = Character, Module = "BeatriceVFX", Function = "cast shield"})
		
		--[[ Fire Client ]]--
		NetworkStream.FireClientDistance(Character,"ClientRemote",200,{Character = Character, Distance = 100, Module = "YamiVFX", Function = "BlackCocoonStart"})
		NetworkStream.FireClientDistance(Character,"ClientRemote",200,{Character = Character, Distance = 10, Module = "YamiVFX", Function = "YamiScreen"})
		...
		local function RemoveBall()
			NetworkStream.FireClientDistance(Character, "ClientRemote", 200, {Character = Character, Module = "BeatriceVFX", Function = "removbal"})
			--[[ Fire Client ]]--
			NetworkStream.FireClientDistance(Character,"ClientRemote",200,{Character = Character, Distance = 100, Module = "YamiVFX", Function = "BlackCocoonEnd"})
			--
	...
	["FourthAbility"] = function(Player,CharacterName,KeyData,MoveData,ExtraData)
		...
		--[[ Screen 2 for Yami ]]--
		NetworkStream.FireClientDistance(Character,"ClientRemote",200,{Character = Character, Distance = 10, Module = "YamiVFX", Function = "YamiScreen2"})
		
		--[[ Slash Charge Up ]]--
		NetworkStream.FireClientDistance(Character,"ClientRemote",200,{Character = Character, Distance = 100, Module = "YamiVFX", Function = "DimensionCharge"})
		for i = 1,3 do
			--[[ Shake ]]--
			CameraRemote:FireClient(Player,"CameraShake",{
				FirstText = 3,
			...
			wait(0.67)
			if i == 2 then NetworkStream.FireClientDistance(Character,"ClientRemote",200,{Character = Character, Distance = 10, Module = "YamiVFX", Function = "YamiScreen"}) end
		end
		NetworkStream.FireClientDistance(Character,"ClientRemote",200,{Character = Character, Distance = 100, Module = "YamiVFX", Velocity = Velocity, Lifetime = Lifetime, Function = "DimensionSlash"})
