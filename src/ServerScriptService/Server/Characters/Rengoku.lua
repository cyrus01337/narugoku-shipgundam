...
local Rengoku = {
	["FirstAbility"] = function(Player,CharacterName,KeyData,MoveData,ExtraData)
		...
		wait(.25)
		NetworkStream.FireClientDistance(Character,"ClientRemote",200,{Character = Character, Module = "RengokuVFX", Function = "WaterStuff", Duration = .35})
		NetworkStream.FireClientDistance(Character,"ClientRemote",200,{Character = Character, Module = "RengokuVFX", Function = "Trail", Sword = Sword, Duration = .6})
		...
		NetworkStream.FireClientDistance(Character,"ClientRemote",200,{Character = Character, Module = "RengokuVFX", Function = "WaterSurfaceSlash", Sword = Sword})
	...
	["SecondAbility"] = function(Player,CharacterName,KeyData,MoveData,ExtraData)
		...
		NetworkStream.FireClientDistance(Character,"ClientRemote",200,{Character = Character, Module = "RengokuVFX", Function = "Trail", Sword = Sword, Duration = .75, Bubbles = "fdsf", TrailFloor = "sdfsf"})
		NetworkStream.FireClientDistance(Character,"ClientRemote",200,{Character = Character, Module = "RengokuVFX", Function = "WaterStuff", Duration = .5})
		...
		NetworkStream.FireClientDistance(Character,"ClientRemote",200,{Character = Character, Module = "RengokuVFX", Function = "secondform"})
	...
	["ThirdAbility"] = function(Player,CharacterName,KeyData,MoveData,ExtraData)
		...
		wait(.25)
		NetworkStream.FireClientDistance(Character,"ClientRemote",200,{Character = Character, Module = "RengokuVFX", Function = "WaterStuff", Duration = .2})
		NetworkStream.FireClientDistance(Character,"ClientRemote",200,{Character = Character, Module = "RengokuVFX", Function = "Trail", Sword = Sword, Duration = .5})
	...
	["FourthAbility"] = function(Player,CharacterName,KeyData,MoveData,ExtraData)
		...
		NetworkStream.FireClientDistance(Character,"ClientRemote",200,{Character = Character, Module = "RengokuVFX", Function = "Trail", Rate = 150, Sword = Sword, TextureLength = 3, Duration = 1.5})

		NetworkStream.FireClientDistance(Character,"ClientRemote",200,{Character = Character, Module = "RengokuVFX", Function = "Striking Tide"})
